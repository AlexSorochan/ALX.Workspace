...
{
    public class WorkspaceItemFramework48 : WorkspaceItemBase
    {
        public const string
            InstalledStr = "Установлен",
            NotInstalledStr = "Не установлен",
            RegParamDisplayName = "DisplayName",
            AppName = "Microsoft .NET Framework 4.8",
        ...
        public override WorkspaceItem ItemType => WorkspaceItem.Framework48;
                    ...
                    Environment.Is64BitOperatingSystem ? Key64 : Key32))
                {
                    ...
                    foreach (string keyName in subKeyNames)
                    {
                        ...
                        using (RegistryKey subKey = keyUninstall.OpenSubKey(keyName))
                        {
                            ...
                            installed = AppName.StartsWith(displayName, StringComparison.OrdinalIgnoreCase);
                            if (installed) break;
                        }
                    }
                }
